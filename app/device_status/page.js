  ...
  const onCheck = async () => {
    try {
      ...
      if (data.result && data.result.registered !== undefined) {
        setCookie("registed", data.result.registered);
      } else {
        setCookie("registed", false);
      }
    ...
    <>
      ...
      <div className="mx-5 md:mx-10 mt-5" id="device_status">
        <div className="lg:mx-96 mb-8 flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#475569" viewBox="0 0 384 512" className="h-28 w-28">
