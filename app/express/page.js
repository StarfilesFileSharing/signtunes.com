    ...
    <>
      ...
      <div className="mx-5 md:mx-10 mt-5">
        <h1 class="text-5xl font-extrabold dark:text-white text-center">
          Signtunes
          <span class="bg-lime-200 text-lime-800 text-2xl font-semibold mx-2 px-2.5 py-0.5 rounded">Express</span>
        </h1>
        <h2 class="m-2 mb-0 text-xl text-neutral-600 text-center dark:text-gray-200">
          Skip hold times on new devices.
        </h2>
        <ProPurchaseButton
          purchaseButton={
            <button
              class="flex m-auto mb-4 rounded-md hover:bg-[#023E8A] px-5 py-2.5 text-sm font-medium text-white shadow bg-primary"
              type="submit"
            >
        ...
        />
        <div class="block lg:mx-96 mb-12 dark:text-gray-900 rounded-xl p-8 shadow-xl bg-bright">
          <h3 class="text-xl font-semibold">What is Signtunes Express?</h3>
          <p class="text-lg mb-4">Signtunes Express completely skips hold times on new devices.</p>
          <h3 class="text-xl font-semibold">How does Signtunes Express work?</h3>
