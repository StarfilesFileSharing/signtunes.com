      ...
      <div className="mx-5 md:mx-10 mt-5">
        ...
        <div className="dark:text-gray-900 block rounded-xl p-8 shadow-xl bg-bright md:w-64 text-center m-auto">
          ...
          <a
            ...
            href={Math.random() < 0.33 ? "https://buy.stripe.com/cN29E90wo3WvdQQ6oz" : (Math.random() < 0.5 ? "https://buy.stripe.com/28oaId7YQgJh288dR3" : "https://buy.stripe.com/3csdUp3IA3WvfYY14i")}
          >
            Install Now
          </a>
          <br />
