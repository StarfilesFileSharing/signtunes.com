...
function Purchase({ params, searchParams }) {
  ...
  function gtag_report_conversion(url) {
    ...
    window.dataLayer.push({
      event: "conversion",
      sendTo: "AW-875730316/wr5HCPKntIcYEIyryqED",
      value: 15.99,
      currency: "USD",
      eventCallback: callback,
    });
    // gtag("event", "conversion", {
    //   send_to: "AW-875730316/wr5HCPKntIcYEIyryqED",
    //   value: 15.99,
    //   currency: "USD",
  ...
  return (
    <>
      ...
      <div className="mx-5 md:mx-10 mt-5">
        ...
        <div className="dark:text-gray-900 block rounded-xl p-8 shadow-xl bg-bright md:w-64 text-center m-auto">
          ...
          <PurchaseButton
            ...
            purchaseButton={
              <button
                type="submit"
                className="mt-6 text-white bg-primary hover:bg-[#023E8A] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={() => {
                  gtag_report_conversion();
                }}
              >
        ...
        <div className="grid md:grid-cols-2 md:gap-x-40 gap-8 md:mx-20 pb-10 dark:text-gray-900">
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.unlimited_installs_description}</p>
          </div>
          {/* <div className="block rounded-xl p-8 shadow-xl bg-bright">
                    ...
                    <p className="mt-4 text-sm text-gray-600">Signtunes has increased entitlements allowing you to enjoy features many other stores don't have such as notification and vpn compatibility.</p>
                </div>  */}
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.largest_library_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.custom_app_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.revoke_protection_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.no_jailbreak_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.designed_with_security_description}</p>
          </div>
          {translationList && (
            <div className="block rounded-xl p-8 shadow-xl bg-bright">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-10 w-10">
              ...
              <p className="mt-4 text-sm text-gray-600">{translationList["247_chat_description"]}</p>
            </div>
          )}
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.sideloading_research_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
              <path
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.appdb_integration_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
              <path
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.gbox_integration_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
              <path
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.scarlet_support_description}</p>
          </div>
          <div className="block rounded-xl p-8 shadow-xl bg-bright">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
              <path
            ...
            <p className="mt-4 text-sm text-gray-600">{translationList?.esign_support_description}</p>
          </div>
        </div>
      </div>
    </>
